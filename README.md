...
- **점심 / 간식 / 저녁** — 맛집을 담을 때 고릅니다. 초대장은 이 순서로 물어봅니다.
...
간식은 **넣을 수도, 건너뛸 수도** 있습니다. 점심을 고르고 나면 간식 메뉴가 뜨고,
`간식은 건너뛸래요` 를 누르면 코스에서 아예 빠집니다.

간식을 고르면 **코스 어디에 넣을지** 물어봅니다. `점심 먹고 바로` 부터
`시장 다음에` 까지, 고정 코스의 각 지점 뒤를 고를 수 있어서 "시장 들렀다가 간식"
같은 순서도 만들 수 있습니다.
